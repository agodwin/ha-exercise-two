...
##### <i>Please Note: You need a GitHub account to complete this step.</i> 
  ...
  please navigate to the public GitHub repository: 

    https://github.com/agodwin/ha-exercise-two
      
  In the top right corner of the page, click the "Fork" button. Now, you 
  have a fork of the original <i>agodwin/ha-exercise-two</i> repository 
